...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, F as utf8ToBytes, G as ExternalError, M as MissingRootKeyErrorCode, H as Certificate, J as lookupResultToBuffer, K as RequestStatusResponseStatus, N as UnknownError, O as RequestStatusDoneNoReplyErrorCode, Q as RejectError, V as CertifiedRejectErrorCode, W as UNREACHABLE_ERROR, Y as InputError, Z as InvalidReadStateRequestErrorCode, _ as ReadRequestType, $ as Principal, a0 as IDL, a1 as MissingCanisterIdErrorCode, a2 as HttpAgent, a3 as encode, a4 as QueryResponseStatus, a5 as UncertifiedRejectErrorCode, a6 as isV3ResponseBody, a7 as isV2ResponseBody, a8 as UncertifiedRejectUpdateErrorCode, a9 as UnexpectedErrorCode, aa as decode, v as Subscribable, ab as pendingThenable, ac as resolveEnabled, w as shallowEqualObjects, ad as resolveStaleTime, D as noop, ae as environmentManager, af as isValidTimeout, ag as timeUntilStale, ah as timeoutManager, ai as focusManager, aj as fetchState, ak as replaceData, z as notifyManager, r as reactExports, E as shouldThrowError, A as useQueryClient, al as useInternetIdentity, am as createActorWithConfig, an as Record, ao as Variant, ap as Opt, aq as Vec, ar as Service, as as Func, at as Text, au as Principal$1, av as Nat, aw as Null, ax as Bool, ay as Int, az as Nat8 } from "./index-BHyAZwjZ.js";
...
const Product = Record({
  "id": ProductId,
  "inStock": Bool,
  "nutritionFacts": Opt(NutritionFacts),
  "name": Text,
  "description": Text,
  "productType": ProductType,
  "sizeVariants": Vec(SizeVariant),
  "category": Category$1,
  "brand": Text,
  "imageId": Opt(Text),
  "ingredients": Text
...
Service({
  ...
  "addAddress": Func([Address], [], []),
  "addProduct": Func([Product], [ProductId], []),
  "addToCart": Func([CartItem], [], []),
  "assignCallerUserRole": Func([Principal$1, UserRole], [], []),
  "clearCart": Func([], [], []),
  "confirmOrder": Func([OrderId], [], []),
  ...
  "removeAddress": Func([Nat], [], []),
  "removeCartItem": Func([Nat, Nat], [], []),
  ...
  "updateCartItem": Func([Nat, Nat, Nat], [], []),
  "updateOrderStatus": Func([OrderId, OrderStatus$1], [], []),
  "updateProduct": Func([Product], [], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const NutritionFacts2 = IDL2.Record({
    "fat": IDL2.Nat,
    "carbs": IDL2.Nat,
    "calories": IDL2.Nat,
    "servingSize": IDL2.Text,
    "protein": IDL2.Nat
  });
  const ProductType2 = IDL2.Text;
  const SizeVariant2 = IDL2.Record({
    "name": IDL2.Text,
    "priceInCents": IDL2.Nat
  });
  const Category2 = IDL2.Variant({
    "preWorkout": IDL2.Null,
    "accessories": IDL2.Null,
    "postWorkout": IDL2.Null,
    "vitamins": IDL2.Null,
    "proteins": IDL2.Null
  });
  const Product2 = IDL2.Record({
    "id": ProductId2,
    "inStock": IDL2.Bool,
    "nutritionFacts": IDL2.Opt(NutritionFacts2),
    "name": IDL2.Text,
    "description": IDL2.Text,
    "productType": ProductType2,
    "sizeVariants": IDL2.Vec(SizeVariant2),
    "category": Category2,
    "brand": IDL2.Text,
    "imageId": IDL2.Opt(IDL2.Text),
    "ingredients": IDL2.Text
  });
  const CartItem2 = IDL2.Record({
    "productId": ProductId2,
    "variantIndex": IDL2.Nat,
    "quantity": IDL2.Nat
  });
  ...
  const Order2 = IDL2.Record({
    "id": OrderId2,
    "status": OrderStatus2,
    "billingAddress": IDL2.Opt(Address2),
  ...
  return IDL2.Service({
    ...
    "addAddress": IDL2.Func([Address2], [], []),
    "addProduct": IDL2.Func([Product2], [ProductId2], []),
    "addToCart": IDL2.Func([CartItem2], [], []),
    "assignCallerUserRole": IDL2.Func([IDL2.Principal, UserRole2], [], []),
    "clearCart": IDL2.Func([], [], []),
    "confirmOrder": IDL2.Func([OrderId2], [], []),
    ...
    "getOrderById": IDL2.Func([OrderId2], [IDL2.Opt(Order2)], ["query"]),
    ...
    "removeAddress": IDL2.Func([IDL2.Nat], [], []),
    "removeCartItem": IDL2.Func([IDL2.Nat, IDL2.Nat], [], []),
    ...
    "updateCartItem": IDL2.Func([IDL2.Nat, IDL2.Nat, IDL2.Nat], [], []),
    "updateOrderStatus": IDL2.Func([OrderId2, OrderStatus2], [], []),
    "updateProduct": IDL2.Func([Product2], [], [])
  });
};
...
var Category = /* @__PURE__ */ ((Category2) => {
  Category2["preWorkout"] = "preWorkout";
  Category2["accessories"] = "accessories";
  Category2["postWorkout"] = "postWorkout";
  Category2["vitamins"] = "vitamins";
  Category2["proteins"] = "proteins";
  return Category2;
})(Category || {});
...
class Backend {
  ...
  async removeCartItem(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async updateCartItem(arg0, arg1, arg2) {
    if (this.processError) {
      try {
...
function from_candid_Category_n22(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n23(_uploadFile, _downloadFile, value);
}
function from_candid_OrderStatus_n13(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n14(_uploadFile, _downloadFile, value);
}
function from_candid_Order_n11(_uploadFile, _downloadFile, value) {
  return from_candid_record_n12(_uploadFile, _downloadFile, value);
}
function from_candid_Product_n19(_uploadFile, _downloadFile, value) {
  return from_candid_record_n20(_uploadFile, _downloadFile, value);
}
function from_candid_StripeSessionStatus_n25(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n23(_uploadFile, _downloadFile, value) {
  return "preWorkout" in value ? "preWorkout" : "accessories" in value ? "accessories" : "postWorkout" in value ? "postWorkout" : "vitamins" in value ? "vitamins" : "proteins" in value ? "proteins" : value;
}
...
function to_candid_OrderStatus_n28(_uploadFile, _downloadFile, value) {
